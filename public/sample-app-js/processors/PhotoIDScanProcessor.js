...
var PhotoIDScanProcessor = /** @class */ (function () {
    function PhotoIDScanProcessor(sessionToken, sampleAppControllerReference) {
        var _this = this;
        ...
        this.processIDScanResultWhileFaceTecSDKWaits = function (idScanResult, idScanResultCallback) {
            ...
            //
            _this.latestNetworkRequest = new XMLHttpRequest();
            _this.latestNetworkRequest.open("POST", Config.BaseURL + "/idscan-only");
                ...
                if (_this.latestNetworkRequest.readyState === XMLHttpRequest.DONE) {
                    try {
                        ...
                        if (responseJSON.wasProcessed === true) {
                            ...
                            FaceTecSDK.FaceTecCustomization.setIDScanResultScreenMessageOverrides("ID Scan Complete", // Successful scan of ID front-side (ID Types with no back-side).
 ...
 */            }
            _this.sampleAppControllerReference.onComplete(null, _this.latestIDScanResult, _this.latestNetworkRequest.status);
        };
...
var PhotoIDScanProcessor = PhotoIDScanProcessor;
